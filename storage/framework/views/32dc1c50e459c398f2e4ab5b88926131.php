    ...
    <div class="relative z-10">
        ...
        <section class="px-5 mb-6">
            <div class="grid grid-cols-3 gap-3">
                <!-- Recharge -->
                <a href="<?php echo e(url('/earnings')); ?>" class="glass rounded-2xl p-4 text-center hover:bg-white/[0.08] transition-all group">
...
<?php /**PATH /home/saeed/Documents/wealthreel-v2/resources/views/me.blade.php ENDPATH**/ ?>