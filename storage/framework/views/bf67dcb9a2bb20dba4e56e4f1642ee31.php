...
<body class="bg-dark-900 text-white min-h-screen pb-8" 
    ...
    <div class="relative z-10">
        ...
        <header class="glass-strong px-5 py-4 flex items-center justify-between sticky top-0 z-50">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(url('/team')); ?>" class="p-2 text-gray-400 hover:text-white transition-colors">
...
<?php /**PATH /home/saeed/Documents/wealthreel-v2/resources/views/invite.blade.php ENDPATH**/ ?>